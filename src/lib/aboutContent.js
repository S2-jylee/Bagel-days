...
export const DEFAULT_ABOUT_CONTENT = {
  // A single field per item now (not separate lead/rest) — **wrapped like
  // this** renders bold, matching the old lead-in styling, but the whole
  // thing is one editable region in admin instead of two side-by-side
  // pencils. See parseStoryText in AboutPageBody.jsx.
  storyList: [
